...
description: Connect your own provider credentials, choose models for tasks, and understand how provider availability works.
...
Provider configuration is explicit. Choose the provider and model for each task. LegionCode does not resell model access.
...
| Cloudflare AI | Supported | Use a Cloudflare API token with Workers AI access |
