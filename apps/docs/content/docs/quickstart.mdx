---
title: Quickstart
description: Sign in, connect a repository and provider, then complete your first reviewed coding-agent task.
...
LegionCode prepares an isolated workspace, streams the agent response and approved tool activity, and records changed files for review.

## Review the result

Open **Review** after the turn produces changes. Check:
