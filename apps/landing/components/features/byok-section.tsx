    ...
    <section id="byok" className="py-24 px-6 border-t border-white/5 bg-black relative select-none overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
          ...
          {/* Box 2: OpenAI */}
          <div className="p-6 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] hover:border-white/10 transition-all duration-300 flex items-center gap-4">
            <div className="w-10 h-10 rounded-lg bg-white/[0.05] border border-white/15 flex items-center justify-center shrink-0">
              <svg className="w-5 h-5 text-white" viewBox="0 0 256 260" fill="currentColor">
        ...
        <div className="flex flex-col flex-wrap gap-x-8 gap-y-3 border-t border-white/[0.03] pt-4 text-sm font-light leading-[1.55] text-zinc-400 select-none sm:flex-row">
          ...
          <div className="flex items-center gap-2">
            <Check className="w-4 h-4 text-emerald-500 shrink-0 stroke-[2.2]" />
            <span>Match each run with the provider and model best suited to the task.</span>
          </div>
          <div className="flex items-center gap-2">
            <Check className="w-4 h-4 text-emerald-500 shrink-0 stroke-[2.2]" />
            <span>Engineered for flexible multi-model orchestration workflows.</span>
          </div>
        </div>
