...
export default function ByokSection() {
  return (
    <section id="byok" className="py-24 px-6 border-t border-white/5 bg-black relative select-none overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex items-center gap-4">
          <span className="text-zinc-500 text-[10px] font-mono uppercase tracking-widest whitespace-nowrap">Use top providers</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
          ...
          <div className="p-6 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] hover:border-white/10 transition-all duration-300 flex items-center gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="text-zinc-500 text-[10px] font-mono mt-0.5">GEMINI_API_KEY</p>
            </div>
          </div>
          ...
          <div className="p-6 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] hover:border-white/10 transition-all duration-300 flex items-center gap-4">
            <div className="w-10 h-10 rounded-lg bg-emerald-500/[0.04] border border-emerald-500/15 flex items-center justify-center shrink-0">
              <svg className="w-5 h-5 text-emerald-400" viewBox="0 0 256 260" fill="currentColor">
            ...
            <div className="min-w-0">
              ...
              <p className="text-zinc-500 text-[10px] font-mono mt-0.5">OPENAI_API_KEY</p>
            </div>
          </div>
          ...
          <div className="p-6 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] hover:border-white/10 transition-all duration-300 flex items-center gap-4">
            ...
            <div className="min-w-0">
              <h4 className="text-white font-medium text-sm">Anthropic Claude</h4>
              <p className="text-zinc-500 text-[10px] font-mono mt-0.5">ANTHROPIC_API_KEY</p>
            </div>
          </div>
          ...
          <div className="p-6 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] hover:border-white/10 transition-all duration-300 flex items-center gap-4">
            <div className="w-10 h-10 rounded-lg bg-indigo-500/[0.04] border border-indigo-500/15 flex items-center justify-center shrink-0">
              <svg className="w-4.5 h-4.5 text-indigo-400" viewBox="0 0 24 24" fill="currentColor">
                <path d="M16 6H8v12h8V6zm4 16H4V2h16v20z" />
              </svg>
            </div>
            <div className="min-w-0">
              <h4 className="text-white font-medium text-sm">OpenCode</h4>
              <p className="text-zinc-500 text-[10px] font-mono mt-0.5">OPENCODE_API_KEY</p>
            </div>
          </div>
          ...
          <div className="p-6 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] hover:border-white/10 transition-all duration-300 flex items-center gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="text-zinc-500 text-[10px] font-mono mt-0.5">OPENROUTER_API_KEY</p>
            </div>
          </div>
          ...
          <div className="p-6 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] hover:border-white/10 transition-all duration-300 flex items-center gap-4">
            <div className="w-10 h-10 rounded-lg bg-orange-500/[0.04] border border-orange-500/15 flex items-center justify-center shrink-0">
              <svg className="w-6 h-auto text-orange-500" viewBox="0 0 256 116" fill="currentColor">
                <path fill="currentColor" fillOpacity="0.15" d="m202.357 49.394-5.311-2.124C172.085 103.434 72.786 69.289 66.81 85.997c-.996 11.286 54.227 2.146 93.706 4.059 12.039.583 18.076 9.671 12.964 24.484l10.069.031c11.615-36.209 48.683-17.73 50.232-29.68-2.545-7.857-42.601 0-31.425-35.497Z" />
                <path fill="currentColor" d="M176.332 108.348c1.593-5.31 1.062-10.622-1.593-13.809-2.656-3.187-6.374-5.31-11.154-5.842L71.17 87.634c-.531 0-1.062-.53-1.593-.53-.531-.532-.531-1.063 0-1.594.531-1.062 1.062-1.594 2.124-1.594l92.946-1.062c11.154-.53 22.839-9.56 27.087-20.182l5.312-13.809c0-.532.531-1.063 0-1.594C191.203 20.182 166.772 0 138.091 0 111.535 0 88.697 16.995 80.73 40.896c-5.311-3.718-11.684-5.843-19.12-5.31-12.747 1.061-22.838 11.683-24.432 24.43-.531 3.187 0 6.374.532 9.56C16.996 70.107 0 87.103 0 108.348c0 2.124 0 3.718.531 5.842 0 1.063 1.062 1.594 1.594 1.594h170.489c1.062 0 2.125-.53 2.125-1.594l1.593-5.842Z" />
                <path fill="currentColor" className="opacity-90" d="M205.544 48.863h-2.656c-.531 0-1.062.53-1.593 1.062l-3.718 12.747c-1.593 5.31-1.062 10.623 1.594 13.809 2.655 3.187 6.373 5.31 11.153 5.843l19.652 1.062c.53 0 1.062.53 1.593.53.53.532.53 1.063 0 1.594-.531 1.063-1.062 1.594-2.125 1.594l-20.182 1.062c-11.154.53-22.838 9.56-27.087 20.182l-1.063 4.78c-.531.532 0 1.594 1.063 1.594h70.108c1.062 0 1.593-.531 1.593-1.593 1.062-4.25 2.124-9.03 2.124-13.81 0-27.618-22.838-50.456-50.456-50.456" />
              </svg>
            </div>
            <div className="min-w-0">
              <h4 className="text-white font-medium text-sm">Cloudflare AI</h4>
              <p className="text-zinc-500 text-[10px] font-mono mt-0.5">CLOUDFLARE_API_TOKEN</p>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-y-3 gap-x-8 text-zinc-400 text-xs sm:text-sm font-light select-none pt-4 border-t border-white/[0.03]">
          <div className="flex items-center gap-2">
            ...
            <span>No keys resold. Keys remain fully local inside your LegionCode local engine.</span>
          </div>
          <div className="flex items-center gap-2">
            <Check className="w-4 h-4 text-emerald-500 shrink-0 stroke-[2.2]" />
            <span>Switch model targets mid-run directly inside the core-terminal.</span>
          </div>
          <div className="flex items-center gap-2">
            <Check className="w-4 h-4 text-emerald-500 shrink-0 stroke-[2.2]" />
            <span>Fully compatible with LegionCode Cloud, Desktop, and CLI harnesses.</span>
          </div>
        </div>
