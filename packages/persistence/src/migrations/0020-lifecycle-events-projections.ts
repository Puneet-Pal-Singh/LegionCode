...
export const lifecycleEventsProjectionsMigration: SqlMigration = {
  id: "0020_lifecycle_events_projections",
  description: "Persist canonical lifecycle events and turn projections",
  statements: [
    `
